...
- [ ] Explain what a token is used for.
      ...
      A token is for a user to see there specific form of state

- [ ] What steps can you take in your web apps to keep your data secure?

      Don't hard code passwords and usernames in code and dont show tokens.

- [ ] Describe how web servers work.

      Basically one computer has a specific function and sends data to a certain ip that requests said data
